...
<body>
    <div style="background :rgb(245, 244, 244)" class="rounded container">
        ...
        <div class="container text-center">
            ...
            <form action="{{route('personnes.store')}}" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <span class="input-group-text" id="basic-addon1">Nom de la personne :</span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">Prénom de la personne :</span>
                    </div>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">Numéro de télephone de la personne :</span>
                    </div>
